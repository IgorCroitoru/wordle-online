...
export function GameRoomColyseus() {
  ...
  const handleBackspace = useCallback(() => {
    ...
    setWrongWord(null);
  }, [currentPlayer, currentGuess, setWrongWord]);
  ...
  const handleEnter = useCallback(() => {
    ...
    // setCurrentGuess("");
  }, [currentPlayer, currentGuess, setWrongWord, makeGuess]);
  ...
  }, [currentGuess, currentPlayer, handleBackspace, handleEnter, handleLetterClick, languageId]);
